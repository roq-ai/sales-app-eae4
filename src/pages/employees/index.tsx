...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'company', 'incentive.count', 'sales.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['job_title.contains'],
          ...params.filters,
        },
        'employee',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'commission_pct', header: 'commission_pct', accessorKey: 'commission_pct' },
    ...
    hasAccess('incentive', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.incentive,
        }
      : null,
