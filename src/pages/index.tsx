  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Sales-App: Empowering Enterprises with Robust Incentive Calculation Software, Designed to Drive Your Business Success and Employee Satisfaction"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbnRlcnByaXNlfGVufDB8fHx8MTY5ODg1MzM3NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@seanpollock?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Sean Pollock`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Sales-App: Empowering Enterprises with Robust Incentive Calculation Software, Designed to Drive Your Business Success and Employee Satisfaction`}
            </Text>
            <Box
