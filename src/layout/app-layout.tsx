...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'hr-manager', 'sales-manager', 'finance-manager', 'employee'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Bonus Allocations',
      path: '/bonus-allocations',
    ...
    { name: 'Incentives', path: '/incentives', entity: 'incentive', service: AccessServiceEnum.PROJECT, icon: FiStar },
    {
